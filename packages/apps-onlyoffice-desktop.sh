...
wget https://download.onlyoffice.com/install/desktop/editors/linux/onlyoffice-desktopeditors_amd64.deb -P /etc/tatsuki/openbox-scripts -c
dpkg -i /etc/tatsuki/openbox-scripts/onlyoffice-desktopeditors_amd64.deb
...
echo "- Icone : /etc/tatsuki/openbox-icons/onlyoffice.svg"
echo " "
