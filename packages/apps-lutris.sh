...
wget https://github.com/lutris/lutris/releases/download/v0.5.17/lutris_0.5.17_all.deb -P /etc/tatsuki/openbox-scripts -c
dpkg -i /etc/tatsuki/openbox-scripts/lutris_0.5.17_all.deb
...
echo "- Icone : /etc/tatsuki/openbox-icons/lutris.svg"
echo " "
